...
HD_PWD='D:/Shared/USN_study/HW_SW_CO_Design/VHDL/Cheating_dice/FSM/Cheating_dice_mealy/Cheating_dice_mealy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cheating_dice.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cheating_dice.tcl -notrace
