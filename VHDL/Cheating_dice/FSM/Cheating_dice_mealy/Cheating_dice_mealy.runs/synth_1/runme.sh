...
HD_PWD='D:/Shared/USN_study/HW_SW_CO_Design/VHDL/Cheating_dice/FSM/Cheating_dice_mealy/Cheating_dice_mealy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cheating_dice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cheating_dice.tcl
