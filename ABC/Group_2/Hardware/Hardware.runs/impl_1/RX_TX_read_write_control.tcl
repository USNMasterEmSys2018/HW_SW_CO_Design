...
set rc [catch {
  ...
  add_files -quiet D:/Shared/USN_study/HW_SW_CO_Design/ABC/Group_2/Hardware/Hardware.runs/synth_1/RX_TX_read_write_control.dcp
  ...
  link_design -top RX_TX_read_write_control -part xc7a35tcpg236-1
