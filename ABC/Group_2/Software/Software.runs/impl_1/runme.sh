...
HD_PWD='D:/Shared/USN_study/HW_SW_CO_Design/ABC/Group_2/Software/Software.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ABC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ABC_wrapper.tcl -notrace
