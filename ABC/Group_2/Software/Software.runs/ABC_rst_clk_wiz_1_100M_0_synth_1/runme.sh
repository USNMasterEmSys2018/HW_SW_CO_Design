...
HD_PWD='D:/Shared/USN_study/HW_SW_CO_Design/ABC/Group 2/Software/Software.runs/ABC_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ABC_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ABC_rst_clk_wiz_1_100M_0.tcl
