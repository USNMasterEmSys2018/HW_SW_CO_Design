...
HD_PWD='D:/Shared/USN_study/HW_SW_CO_Design/ABC/Group_2/Software/Software.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ABC_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ABC_wrapper.tcl
