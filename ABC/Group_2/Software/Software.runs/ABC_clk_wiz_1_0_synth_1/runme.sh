...
HD_PWD='D:/Shared/USN_study/HW_SW_CO_Design/ABC/Group 2/Software/Software.runs/ABC_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ABC_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ABC_clk_wiz_1_0.tcl
